...
\
  ...
  # Create instance: top_query_strategy_0, and set properties
  set block_name top_query_strategy
  set block_cell_name top_query_strategy_0
  if { [catch {set top_query_strategy_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $top_query_strategy_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net top_query_strategy_0_BRAM_PORTA [get_bd_intf_pins top_query_strategy_0/BRAM_PORTA] [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTA]
  connect_bd_intf_net -intf_net top_query_strategy_0_BRAM_PORTB [get_bd_intf_pins blk_mem_gen_1/BRAM_PORTA] [get_bd_intf_pins top_query_strategy_0/BRAM_PORTB]

  # Create port connections
  connect_bd_net -net axi_gpio_0_gpio_io_o  [get_bd_pins axi_gpio_0/gpio_io_o] \
  [get_bd_pins top_query_strategy_0/start]
  ...
  [get_bd_pins top_query_strategy_0/clk]
  ...
  [get_bd_pins top_query_strategy_0/rst_n]
  connect_bd_net -net top_query_strategy_0_ready  [get_bd_pins top_query_strategy_0/ready] \
